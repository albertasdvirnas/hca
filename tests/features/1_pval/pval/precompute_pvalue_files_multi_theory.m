function [t] = precompute_pvalue_files_multi_theory(setsFile,lengths,outfold)
...
%         k
        ...
        parfor i = lenMin:lenMax
            ...
            if isLinearD
                rand2 = normrnd(0,1, 1, 2*curLen);
                rand2 = convolve_bar(rand2, psf, 2*curLen );
                rand2 = rand2(1:curLen);
            else %circular
                rand2 = normrnd(0,1, 1, curLen);
                rand2 = convolve_bar(rand2, psf, curLen );
            end
