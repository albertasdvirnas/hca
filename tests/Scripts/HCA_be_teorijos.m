function [hcaStruct] = HCA_be_teorijos(sets, hcaStruct)
    % HCA_be_teorijos
...
%         [ kymoStructs,barcodeGenMol,consensusStructs ] = align_kymos_consensus( sets, kymoStructs );
...
% 
%    % assign all to base
        hcaStruct.barcodeGen = barcodeGen;
