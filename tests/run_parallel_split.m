function [hcaStruct] = run_parallel_split(setsFile, theories, kymoFile, numFrames, nmBp,comparisonMethod)
    % HCA_Gui
...
%         gen_consensus_plot(consensusStructs,sets);
        ...
        if sets.random.generate
            ...
            barcodeGenC = barcodeGen;
                ...
                % generate random cut-outs
%         sets.subfragment.generate = 1;
%         sets.subfragment.numberFragments = 3;
